...
mortalidad_aire <-
  full_join(x = media_calidad_aire, y = mortalidad_prenatal, by = c("Comunidades_Autonomas", "Año")) %>%
...
mortalidad_RUIDO <- 
  full_join(x = RUIDO_CCAA, y = mortalidad_prenatal_RUIDO, by = c("Comunidades_Autonomas", "Año"))%>%
