...
grafico_mort <- ggplot(mortalidad, aes(x = Año, y = Mortalidad, color = Comunidades_Autonomas, group = Comunidades_Autonomas)) + geom_line() +  
  geom_point() +  
  labs(
    title = "Mortalidad Prenatal por Comunidad Autónoma",
    x = "Año",
    y = "Mortalidad Infantil (por 1,000 nacidos vivos)",
    color = "Comunidad Autónoma"
  ) +
  theme_minimal()

grafico_interactivo_mort <- ggplotly(grafico_mort)

grafico_interactivo_mort
```
...
A continuación relacionaremos las dos tablas de contaminación, obteniendo un valor medio entre estas PM2.5 y PM10, para posteriormente hacer la unión con la mortalidad.
...
En este apartado se estudiará la evolución de la población afectada por ruidos externos a lo largo de los años en cada comunidad autónoma y su posible relación con el número de muertes fetales tardías.
...
```{r , eval = TRUE,message=FALSE}
ggplot(RUIDO_CCAA, aes(x = Año, y = Ruido, color = Comunidades_Autonomas, group = Comunidades_Autonomas)) +
  geom_point() +
  geom_line()+
...
```{r , eval = TRUE,message=FALSE}
ggplot(RUIDO_CCAA, aes(x = Año, y = Ruido, color = Comunidades_Autonomas, group = Comunidades_Autonomas)) +
  geom_line() +  # Trazar las líneas
  geom_point() +  # Añadir puntos en los datos
  labs(
    title = "Mortalidad Infantil por Comunidad Autónoma",
    x = "Año",
    y = "Mortalidad Infantil (por 1,000 nacidos vivos)",
    color = "Comunidad Autónoma"
  ) +
