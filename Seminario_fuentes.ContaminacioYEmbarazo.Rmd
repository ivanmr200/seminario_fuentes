...
La **mortalidad prenatal** o **mortalidad fetal tardía** se refiere a aquellos bebés que fallecen pasadas las 28 semanas de embarazo (a partir del séptimo mes) y que no llegan a término (OMS).
...
Se observa que hay una gran diferencia en la evolución de las tasas de mortalidad prenatal dependiendo de la Comunidad Autónoma, destacando grandes tasas en Ceuta, Melilla y La Rioja.
...
Sin embargo, si analizamos los primeros años desde 2004 hasta 2008, estos valores medios tienen valores muchos más altos, alcanzando el máximo en Aragón. Es notable como a partir del **2008** dichos valores descienden de forma drástica. 
...
Además cabe destacar que en regiones como Melilla, Ceuta, Murcia y Andalucía, los niveles de contaminación de PM no solo incluyen los datos de contaminantes atmosféricos emitidos por los humanos, sino que también incluyen otro tipo de contaminante inevitable como es la nacionalmente conocida **"calima"** que proviene de África y trae consigo una gran cantidad de particulas (generalmente arena), que dependiendo de su tamaño podrían ser introducidas en la categoría de las PM. 
...
ggplot(data_and, aes(x = media_PM, y = Mortalidad)) +
  ...
  labs(title = "Relación entre la concentración de PM y la mortalidad prenatal en Andalucía",
...
ggplot(data_arg, aes(x = media_PM, y = Mortalidad)) +
  geom_point(aes(color = factor(Año))) +                
  geom_smooth(method = "lm", color = "red", se = TRUE) + 
  labs(title = "Relación entre la concentración de PM y la mortalidad prenatal en Aragón",
       x = "Concentración de PM (µg/m³)",
       y = "Tasa de mortalidad Prenatal",
       color = "Año") +
  theme_minimal()+
...
ggplot(data_bal, aes(x = media_PM, y = Mortalidad)) +
  geom_point(aes(color = factor(Año))) +                
  geom_smooth(method = "lm", color = "red", se = TRUE) + 
  labs(title = "Relación entre la concentración de PM y la mortalidad prenatal en I.Baleares",
       x = "Concentración de PM (µg/m³)",
       y = "Tasa de mortalidad Prenatal",
       color = "Año") +
  theme_minimal()+
...
ggplot(data_can, aes(x = media_PM, y = Mortalidad)) +
  geom_point(aes(color = factor(Año))) +                
  geom_smooth(method = "lm", color = "red", se = TRUE) + 
  labs(title = "Relación entre la concentración de PM y la mortalidad prenatal en Canarias",
       x = "Concentración de PM (µg/m³)",
       y = "Tasa de mortalidad Prenatal",
       color = "Año") +
  theme_minimal()+
...
ggplot(data_cant, aes(x = media_PM, y = Mortalidad)) +
  geom_point(aes(color = factor(Año))) +                
  geom_smooth(method = "lm", color = "red", se = TRUE) + 
  labs(title = "Relación entre la concentración de PM y la mortalidad prenatal en Cantabria",
       x = "Concentración de PM (µg/m³)",
       y = "Tasa de mortalidad Prenatal",
       color = "Año") +
  theme_minimal()+
...
ggplot(data_cyl, aes(x = media_PM, y = Mortalidad)) +
  geom_point(aes(color = factor(Año))) +                
  geom_smooth(method = "lm", color = "red", se = TRUE) + 
  labs(title = "Relación entre la concentración de PM y la mortalidad prenatal en Castilla y León",
       x = "Concentración de PM (µg/m³)",
       y = "Tasa de mortalidad Prenatal") +
  theme_minimal()+
  theme(legend.position = "bottom")
...
ggplot(data_clm, aes(x = media_PM, y = Mortalidad)) +
  geom_point(aes(color = factor(Año))) +                
  geom_smooth(method = "lm", color = "red", se = TRUE) + 
  labs(title = "Relación entre la concentración de PM y la mortalidad prenatal en Castilla - La Mancha",
       x = "Concentración de PM (µg/m³)",
       y = "Tasa de mortalidad Prenatal") +
  theme_minimal()+
  theme(legend.position = "bottom")
...
ggplot(data_ctl, aes(x = media_PM, y = Mortalidad)) +
  geom_point(aes(color = factor(Año))) +                
  geom_smooth(method = "lm", color = "red", se = TRUE) + 
  labs(title = "Relación entre la concentración de PM y la mortalidad prenatal en Cataluña",
       x = "Concentración de PM (µg/m³)",
       y = "Tasa de mortalidad Prenatal") +
  theme_minimal()+
  theme(legend.position = "bottom")
...
ggplot(data_vlc, aes(x = media_PM, y = Mortalidad)) +
  geom_point(aes(color = factor(Año))) +                
  geom_smooth(method = "lm", color = "red", se = TRUE) + 
  labs(title = "Relación entre la concentración de PM y la mortalidad prenatal en Comunitat Valenciana",
       x = "Concentración de PM (µg/m³)",
       y = "Tasa de mortalidad Prenatal") +
  theme_minimal()+
  theme(legend.position = "bottom")
...
ggplot(data_ext, aes(x = media_PM, y = Mortalidad)) +
  geom_point(aes(color = factor(Año))) +                
  geom_smooth(method = "lm", color = "red", se = TRUE) + 
  labs(title = "Relación entre la concentración de PM y la mortalidad prenatal en Extremadura",
       x = "Concentración de PM (µg/m³)",
       y = "Tasa de mortalidad Prenatal") +
  theme_minimal()+
  theme(legend.position = "bottom")
...
ggplot(data_gal, aes(x = media_PM, y = Mortalidad)) +
  geom_point(aes(color = factor(Año))) +                
  geom_smooth(method = "lm", color = "red", se = TRUE) + 
  labs(title = "Relación entre la concentración de PM y la mortalidad prenatal en Galicia",
       x = "Concentración de PM (µg/m³)",
       y = "Tasa de mortalidad Prenatal") +
  theme_minimal()+
  theme(legend.position = "bottom")
...
ggplot(data_mad, aes(x = media_PM, y = Mortalidad)) +
  geom_point(aes(color = factor(Año))) +                
  geom_smooth(method = "lm", color = "red", se = TRUE) + 
  labs(title = "Relación entre la concentración de PM y la mortalidad prenatal en Madrid",
       x = "Concentración de PM (µg/m³)",
       y = "Tasa de mortalidad Prenatal") +
  theme_minimal()+
  theme(legend.position = "bottom")
...
ggplot(data_mur, aes(x = media_PM, y = Mortalidad)) +
  geom_point(aes(color = factor(Año))) +                
  geom_smooth(method = "lm", color = "red", se = TRUE) + 
  labs(title = "Relación entre la concentración de PM y la mortalidad prenatal en Murcia",
       x = "Concentración de PM (µg/m³)",
       y = "Tasa de mortalidad Prenatal") +
  theme_minimal()+
  theme(legend.position = "bottom")
...
ggplot(data_nav, aes(x = media_PM, y = Mortalidad)) +
  geom_point(aes(color = factor(Año))) +                
  geom_smooth(method = "lm", color = "red", se = TRUE) + 
  labs(title = "Relación entre la concentración de PM y la mortalidad prenatal en Navarra",
       x = "Concentración de PM (µg/m³)",
       y = "Tasa de mortalidad Prenatal") +
  theme_minimal()+
  theme(legend.position = "bottom")
...
ggplot(data_pv, aes(x = media_PM, y = Mortalidad)) +
  geom_point(aes(color = factor(Año))) +                
  geom_smooth(method = "lm", color = "red", se = TRUE) + 
  labs(title = "Relación entre la concentración de PM y la mortalidad prenatal en Pais Vasco",
       x = "Concentración de PM (µg/m³)",
       y = "Tasa de mortalidad Prenatal") +
  theme_minimal()+
  theme(legend.position = "bottom")
...
ggplot(data_rioj, aes(x = media_PM, y = Mortalidad)) +
  geom_point(aes(color = factor(Año))) +                
  geom_smooth(method = "lm", color = "red", se = TRUE) + 
  labs(title = "Relación entre la concentración de PM y la mortalidad prenatal en La Rioja",
       x = "Concentración de PM (µg/m³)",
       y = "Tasa de mortalidad Prenatal") +
  theme_minimal()+
  theme(legend.position = "bottom")
...
ggplot(data_ceu, aes(x = media_PM, y = Mortalidad)) +
  geom_point(aes(color = factor(Año))) +                
  geom_smooth(method = "lm", color = "red", se = TRUE) + 
  labs(title = "Relación entre la concentración de PM y la mortalidad prenatal en Ceuta",
       x = "Concentración de PM (µg/m³)",
       y = "Tasa de mortalidad Prenatal") +
  theme_minimal()+
  theme(legend.position = "bottom")
...
ggplot(data_mel, aes(x = media_PM, y = Mortalidad)) +
  geom_point(aes(color = factor(Año))) +                
  geom_smooth(method = "lm", color = "red", se = TRUE) + 
  labs(title = "Relación entre la concentración de PM y la mortalidad prenatal en Melilla",
       x = "Concentración de PM (µg/m³)",
       y = "Tasa de mortalidad Prenatal") +
  theme_minimal()+
  theme(legend.position = "bottom")
...
grafico_animado <- ggplot(ccaa_sf) +
  ...
  scale_fill_gradientn(
    colors = hcl.colors(10, "Blues", rev = TRUE),
    n.breaks = 10,
    guide = guide_legend(title = "%Población_Ruido", position = "inside")
  ) +
  theme_void() +
  theme(legend.position = c(0.1, 0.6)) +
...
El ruido puede ser uno de los factores que puedan causar problemas en el embarazo, ya que si la madre es sometida a grandes cantidades de ruido, sus niveles de estrés pueden aumentar llegando a afectar al embarazo.

Las siguientes gráficas tratan de demostrar si existe realación entre población afectada por ruido y mortalidad prenatal. Dependiendo de la Comunidad Autónoma que se eliga , presentan un comportamiento distinto. 

Por ejemplo, en Andalucía se muestra como la línea de tendencia es ascendente y gran parte de los valores se encuentran dentro de los intervalos de confianza lo que indican que si que existe cierta correlación entre la población afectada por ruido y la mortalidad prenatal. Aunque como la pendiente de la línea no es muy pronunciada, la correlación no es muy fuerte.

En otros casos, como Melilla en los que los gráfico anteriores mostraba una gran tasa de mortalidad prenatal y población afectada por ruido, nos daría a pensar que tendrían una correlación muy fuerte, pero parece que el gráfico desmonta esta teoría mostrando una línea de tendencia que desciende ligeramente indicando que no tienen gran correlación. Llegando a la conclusión de que el ruido tampoco parece tener una relación influyente en los embarazos. 

En resumen, los resultados indican que la relación entre el ruido y la mortalidad prenatal varían según la Comunidad Autónoma, llegando en algunos casos a tener relación y en otros no. 
Esto nos lleva a pensar que el ruido puede ser un factor de riesgo indirecto, pero no una de las causas determinantes de la mortalidad prenatal.
...
Los resultados obtenidos nos permiten resolver la pregunta del objetivo general: *¿La contaminación del aire y la exposición al ruido pueden estar asociados con el número de casos de mortalidad fetal?*

En cuanto a la **contaminación del aire**, se obtiene que si existe cierta relación con la mortalidad prenatal ya que en algunas comunidades autónomas en momentos de máxima contaminación presentaban niveles de mortalidad prenatal elevados.

Sobre la **contaminación acústica** se observaron resultados más diversos en el que en algunas comunidades la relación parece ser positiva en cambio en otras parece ser nula.

En conclusión, podemos sugerir que tanto la contaminación del aire y la acústica parecen ser **factores de riesgos indirectos** ya que sí que pueden llegar a afectar al embarazo causando problemas, pero no se podrían considerar una causa directa por los distintos tipos de respuesta en cuanto a la correlación en cada Comunidad Autónoma.


## **Bibliografía**

  1. Prisma. (2023, January 5). Las partículas PM10 y cómo se generan. Eurofins Environment Testing Spain. https://www.eurofins-environment.es/es/particulas-pm10-y-como-se-generan/

  2. Muerte prenatal. (n.d.). Www.who.int. https://www.who.int/es/health-topics/stillbirth#tab=tab_2

  3. DeFranco, E., Hall, E., Hossain, M., Chen, A., Haynes, E. N., Jones, D., Ren, S., Lu, L., & Muglia, L. (2015). Air pollution and stillbirth risk: exposure to airborne particulate matter during pregnancy is associated with fetal death. PloS one, 10(3), e0120594. https://doi.org/10.1371/journal.pone.0120594

  4. Nyadanu, S. D., Dunne, J., Tessema, G. A., Mullins, B., Kumi-Boateng, B., Lee Bell, M., Duko, B., & Pereira, G. (2022). Prenatal exposure to ambient air pollution and adverse birth outcomes: An umbrella review of 36 systematic reviews and meta-analyses. Environmental pollution (Barking, Essex : 1987), 306, 119465. https://doi.org/10.1016/j.envpol.2022.119465

  5. Siddika, N., Balogun, H. A., Amegah, A. K., & Jaakkola, J. J. (2016). Prenatal ambient air pollution exposure and the risk of stillbirth: systematic review and meta-analysis of the empirical evidence. Occupational and environmental medicine, 73(9), 573–581. https://doi.org/10.1136/oemed-2015-103086

  6. Sivakumaran, K., Ritonja, J. A., Waseem, H., AlShenaibar, L., Morgan, E., Ahmadi, S. A., Denning, A., Michaud, D., & Morgan, R. L. (2022). Impact of Noise Exposure on Risk of Developing Stress-Related Obstetric Health Effects: A Systematic Review and Meta-Analysis. Noise & health, 24(114), 137–144. https://doi.org/10.4103/nah.nah_22_22

  7. A Grammar of Animated Graphics. (n.d.). Gganimate.com. https://gganimate.com/

  8. mapSpain: Mapas de España en R [Spanish]. (2021). Github.io. https://ropenspain.github.io/mapSpain/articles/x02_mapasesp.html

  9. INE. (2019). Instituto Nacional de Estadistica. (Spanish Statistical Office). Www.ine.es. https://www.ine.es/

  10. ariamsita. (2021, March 6). tuto[R]iales: haciendo mapas de España con R. YouTube. https://www.youtube.com/watch?v=N00NbrQ1KSQ
